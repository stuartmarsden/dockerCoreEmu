...
RUN wget http://downloads.pf.itd.nrl.navy.mil/core/packages/4.7/core-gui_4.7-0ubuntu1_trusty_all.deb
RUN wget http://downloads.pf.itd.nrl.navy.mil/core/packages/4.7/core-daemon_4.7-0ubuntu1_trusty_amd64.deb
RUN wget http://downloads.pf.itd.nrl.navy.mil/ospf-manet/quagga-0.99.21mr2.2/quagga-mr_0.99.21mr2.2_amd64.deb
RUN dpkg -i core-gui_4.7-0ubuntu1_trusty_all.deb core-daemon_4.7-0ubuntu1_trusty_amd64.deb quagga-mr_0.99.21mr2.2_amd64.deb
